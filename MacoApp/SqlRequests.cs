    ...
    internal class SqlRequests
    {
        ...
        public int Que(string Rotation, string Furn, int FFH, int FFB)
        {
            ...
            if (Furn == "Maco_Eco")
            {
                ...
                else if (FFH >= 901 && FFH <= 1300 && FFB >= 801 && FFB <= 1300 && Rotation == "Нет")
                {
                    return quantityBar = 5;
                }
                ...
                else if (FFH >= 1301 && FFH <= 1800 && FFB >= 801 && FFB <= 1300 && Rotation == "Нет")
                {
                    return quantityBar = 7;
                }
                ...
                else if (FFH >= 1801 && FFH <= 2350 && FFB >= 801 && FFB <= 1300 && Rotation == "Нет")
                {
            ...
            {
                if (FFH >= 450 && FFH <= 700 && FFB <= 650 && Rotation == "Нет")
                {
                    return quantityBar = 3;
                }
                else if (FFH >= 450 && FFH <= 700 && FFB >= 651 && FFB <= 850 && Rotation == "Нет")
                {
                    return quantityBar = 4;
                }
                else if (FFH >= 450 && FFH <= 700 && FFB >= 851 && Rotation == "Нет")
                {
                    return quantityBar = 5;
                }
                //**********************
                if (FFH >= 701 && FFH <= 1200 && FFB <= 650 && Rotation == "Нет")
                {
                    return quantityBar = 3;
                }
                else if (FFH >= 701 && FFH <= 1200 && FFB >= 651 && FFB <= 850 && Rotation == "Нет")
                {
                    return quantityBar = 5;
                }
                else if (FFH >= 701 && FFH <= 1200 && FFB >= 851 && Rotation == "Нет")
                {
                    return quantityBar = 6;
                }
                //**********************
                if (FFH >= 1201 && FFH <= 1700 && FFB <= 650 && Rotation == "Нет")
                {
                    return quantityBar = 5;
                }
                else if (FFH >= 1201 && FFH <= 1700 && FFB >= 651 && FFB <= 850 && Rotation == "Нет")
                {
                    return quantityBar = 7;
                }
                else if (FFH >= 1201 && FFH <= 1700 && FFB >= 851 && Rotation == "Нет")
                {
                    return quantityBar = 8;
                }
                //**********************
                if (FFH >= 1701 && FFH <= 1900 && FFB <= 650 && Rotation == "Нет")
                {
                    return quantityBar = 6;
                }
                else if (FFH >= 1701 && FFH <= 1900 && FFB >= 651 && FFB <= 850 && Rotation == "Нет")
                {
                    return quantityBar = 8;
                }
                else if (FFH >= 1701 && FFH <= 1900 && FFB >= 851 && Rotation == "Нет")
                {
                    return quantityBar = 9;
                }
                //**********************
                if (FFH >= 1901 && FFH <= 2400 && FFB <= 650 && Rotation == "Нет")
                {
                    return quantityBar = 7;
                }
                else if (FFH >= 1901 && FFH <= 2400 && FFB >= 651 && FFB <= 850 && Rotation == "Нет")
                {
                    return quantityBar = 8;
                }
                else if (FFH >= 1901 && FFH <= 2400 && FFB >= 851 && Rotation == "Нет")
                {
