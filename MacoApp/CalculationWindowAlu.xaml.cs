...
namespace MacoApp
{
    public partial class CalculationWindowAlu : Window
    {
        string SavePathTXT;
        ...
        List<string> ArticleFram1 = new List<string> { "52480","52486","52487","94491","42083","42084","V12010102",
            ...
            "52321","264015","230651","264007","1090505","1090506","V16030102", "1084761", "1107269", "1086935", "1107281", "ELM6000100", "ELM4080101", "101548"};
        List<string> ArticleFram2 = new List<string> { "101548", "V05010102", "482823", "1099150", };
        //Список ответных планок
        List<string> response_bars = new List<string> { "34623", "34850", "34780", "V25140102", "V25070102", "V26010102", "V25010102", "338070", "457612", "260367", "1077591",
            "1077246", "1099378", "1082704", "ELM0020E00", "ELM0050E00", "373549", "373550"};
        List<string> response_barsSthulp = new List<string> { "34623", "34850", "34780", "V25140102", "V25070102", "V26010102", "V25010102", "338070","457612", "260367", "1077591",
                    ...
                    using (SqliteDataReader reader = command.ExecuteReader())
                    {
                        if (reader.HasRows) // если есть данные
                        {
                            ...
                            LBListCalc.Items.Add("" + Count + ". " + Furn + ": " + TextBoxFFB.Text + "/" +
                                TextBoxFFH.Text + ", " + ComboBoxSystem.Text + "я, Откр. " + ComboBoxSide.Text + ", Ниж. петл.- " +
                                " " + TextBoxColvo.Text + " шт.");
